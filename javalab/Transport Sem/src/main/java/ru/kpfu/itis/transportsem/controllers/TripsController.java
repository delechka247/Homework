...
public class TripsController {
    ...
    public ReservationDto addTripReservation(@RequestHeader("TOKEN") String token, @RequestHeader("REFRESH-TOKEN") String refreshToken, @PathVariable("trip-id") Long tripId) {
    ...
    @PostMapping("/trips")
    public TripDto addTrip(@RequestHeader("TOKEN") String token, @RequestHeader("REFRESH-TOKEN") String refreshToken, @RequestBody TripDto tripDto) {
    ...
    public List<TripDto> findTrip(@RequestHeader("TOKEN") String token, @RequestHeader("REFRESH-TOKEN") String refreshToken, @RequestBody TripSearchForm tripSearchForm) {
    ...
    public TripDto updateTrip(@RequestHeader("TOKEN") String token, @RequestHeader("REFRESH-TOKEN") String refreshToken, @PathVariable("trip-id") Long tripId, @RequestBody TripDto tripDto) {
