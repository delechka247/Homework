...
public class ReservationsController {
    ...
    public List<ReservationDto> getReservations(@RequestHeader("TOKEN") String token, @RequestHeader("REFRESH-TOKEN") String refreshToken) {
    ...
    public ReservationDto addTripReservation(@RequestHeader("TOKEN") String token, @RequestHeader("REFRESH-TOKEN") String refreshToken, @RequestBody List<Long> tripIdList) {
